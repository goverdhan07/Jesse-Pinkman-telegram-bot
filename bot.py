...
token = '1110302513:AAEbvUpTQ-uhq_y2aXvsa4LMbpROSYb9ZQs' #Token of your bot
mrPinkmanBot = BotHandler(token) #Your bot's name
        ...
        if len(all_updates) > 0:
            for current_update in all_updates:
                ...
                if first_chat_text == 'Hi':
                   mrPinkmanBot.send_message(first_chat_id, 'Morning ' + first_chat_name)
                   new_offset = first_update_id + 1
                elif first_chat_text == 'motivate me':
                    mrPinkmanBot.send_message(first_chat_id, quote)
                    new_offset = first_update_id + 1
                else:
                    mrPinkmanBot.send_message(first_chat_id, 'How are you doing '+first_chat_name)
                    new_offset = first_update_id + 1
